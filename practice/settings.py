...
SECRET_KEY = 'django-insecure-(fi=we-hi=z5a=6zd_#hb26!7oicd!x%jy=d!7b0*nxn-vj7w='
...
MIDDLEWARE = [
    ...
    # 'library.middleware.BlacklistMiddelware',
]
...
FIXTURE_DIRS = [
    os.path.join(BASE_DIR, 'library/fixtures'),  # مسیر پوشه fixtures
]
